...
page history by source/status, search title/message text, and sort it by newest, oldest, or severity-first when many
old alerts have accumulated. The filtered and searched history can also be exported as CSV from the local manager.
