...
class WebSettingsTests(unittest.TestCase):
    def test_index_includes_storage_and_collector_settings_forms(self) -> None:
        ...
        self.assertIn('name="quarantine_data_dir"', body)
        self.assertIn('id="collectorSettingsForm"', body)
        self.assertIn("Read-only quarantine planning", body)
        self.assertIn("data-quarantine-planner-form", body)
        self.assertIn("/quarantine-plans", body)
        self.assertIn("Isolated quarantine rehearsal", body)
        self.assertIn("data-quarantine-rehearsal-form", body)
        self.assertIn("/quarantine-rehearsals", body)
        self.assertIn("Isolated combined deletion rehearsal", body)
        self.assertIn("data-combined-rehearsal-form", body)
        self.assertIn("/combined-rehearsals", body)
        self.assertIn("/settings/storage", body)
        self.assertIn("/settings/collector", body)
        self.assertIn('id="alerts"', body)
        self.assertIn('id="alertSettingsForm"', body)
        self.assertIn('id="alertDiscordGuildSelect"', body)
        self.assertIn('id="alertDiscordChannelSelect"', body)
        self.assertIn('id="alertDiscordChannelSelection"', body)
        self.assertIn('/discord/channels?guild_id=', body)
        self.assertIn('id="discordCommandGroupForm"', body)
        self.assertIn('id="discordCommandCatalog"', body)
        self.assertIn('id="discordCommandAliasForm"', body)
        ...
        self.assertIn('id="alertHistoryCopyFilterLink"', body)
        ...
        self.assertIn('placeholder="제목 또는 내용"', body)
        ...
        self.assertIn("정렬 ${alertHistoryPage.sort", body)
        self.assertIn("검색 ${alertHistoryPage.search", body)
        self.assertIn("심각도 ${alertHistoryPage.severity", body)
        ...
        self.assertIn("loadInitialAlertHistoryFiltersFromUrl", body)
        self.assertIn("alertHistoryFilterUrl", body)
        self.assertIn("copyAlertHistoryFilterLink", body)
        self.assertIn("updateAlertHistoryFilterUrl", body)
        self.assertIn('url.hash = "alerts"', body)
        self.assertIn("initialAlertHistoryFilterFromUrl", body)
        self.assertIn("refreshAlertsAndHistory", body)
        self.assertIn("alert_history_source", body)
        self.assertIn("alert_history_offset", body)
        self.assertIn("알림 이력 조회 링크 복사 완료", body)
        ...
        self.assertEqual(
            body.count('data-reset-analysis-form="workerRunFilterForm"'),
            1,
        )
        self.assertIn('id="workerRunsStatus"', body)
        self.assertIn('id="workerRunsExport"', body)
        self.assertIn('id="workerRunsCopyFilterLink"', body)
        ...
        self.assertIn('name="quick_range"', body)
        self.assertIn('value="last_24h"', body)
        self.assertIn('value="last_7d"', body)
        ...
        self.assertIn("loadInitialWorkerRunFiltersFromUrl", body)
        self.assertIn("workerRunFilterUrl", body)
        self.assertIn("copyWorkerRunFilterLink", body)
        self.assertIn("updateWorkerRunFilterUrl", body)
        self.assertIn('url.hash = "worker-runs"', body)
        self.assertIn('url.hash = "workerRunDetail"', body)
        self.assertIn("worker_run_worker", body)
        self.assertIn("worker_run_from", body)
        self.assertIn("worker_run_offset", body)
        ...
        self.assertIn("normalizeWorkerRunQuickRange", body)
        self.assertIn("applyWorkerRunQuickRange", body)
        self.assertIn("workerRunQuickRangeValues", body)
        self.assertIn("rangeLabels", body)
        self.assertIn("시각 ${workerRunDateRangeLabel", body)
        self.assertIn("요약 지표", body)
        self.assertIn("저장된 오류", body)
        self.assertIn('id="workspaceSections"', body)
        self.assertIn("workspaceSectionsByView", body)
        self.assertIn("renderWorkspaceSections", body)
        self.assertIn('main > section[data-view][hidden]', body)
        self.assertIn('id="alertHistoryCards"', body)
        self.assertIn('id="workerRunsCards"', body)
        self.assertIn('id="jobsCards"', body)
        self.assertIn('id="telemetryJobsCards"', body)
        ...
        self.assertIn("historical-severity", body)
        ...
        self.assertIn("renderDataDeletionPreview", body)
        self.assertIn("Loading read-only impact preview", body)
        self.assertIn("checksum verification: not performed", body)
        self.assertIn("renderDataDeletionConfirmationState", body)
        self.assertIn("Capture immutable snapshot", body)
        self.assertIn("Record confirmation", body)
        self.assertIn("Fingerprint-bound confirmation recorded", body)
        self.assertIn("renderDataDeletionDryRunState", body)
        self.assertIn("overflow-x: auto", body)
        self.assertIn("deletion-request-table", body)
        self.assertIn("table-scroll", body)
        self.assertIn(".dry-run-contract .table-scroll", body)
        ...
        self.assertIn("checksum recalculation: no", body)
        self.assertIn("restore operation: no", body)
        self.assertIn("Isolated combined fault matrix", body)
        self.assertIn("1 MySQL temporary-table fault + 3 synthetic quarantine faults", body)
        self.assertIn("data-fault-matrix-form", body)
        self.assertIn("runDataDeletionFaultMatrix", body)
        self.assertIn("/fault-matrix-runs", body)
        self.assertIn("Declared fault scenarios", body)
        self.assertIn("Advisory deletion review packet", body)
        self.assertIn("Immutable JSON audit packet: yes", body)
        self.assertIn("Deletion request", body)
        self.assertIn("data-review-packet-form", body)
        self.assertIn("generateDataDeletionReviewPacket", body)
        self.assertIn("/review-packets", body)
        self.assertIn("/export.json", body)
        self.assertIn("authorization granted: no", body)
        self.assertIn("readiness promoted: no", body)
        self.assertIn("Exported review packet verifier", body)
        self.assertIn('id="exportedReviewPacketVerifierForm"', body)
        self.assertIn('type="file"', body)
        self.assertIn("Current MySQL chain", body)
        self.assertIn("uploaded text persisted: no", body)
        self.assertIn("renderExportedReviewPacketVerification", body)
        self.assertIn("verifyExportedReviewPacket", body)
        self.assertIn("/data-deletion-review-packets/verify", body)
        self.assertIn("2097152", body)
        self.assertIn(".review-packet-verifier-form { grid-template-columns: 1fr; }", body)
        self.assertIn("Review packet comparison", body)
        self.assertIn('id="exportedReviewPacketComparerForm"', body)
        self.assertIn("Baseline JSON", body)
        self.assertIn("Candidate JSON", body)
        self.assertIn("Current MySQL chain for both", body)
        self.assertIn("comparison persisted: no", body)
        self.assertIn("renderExportedReviewPacketComparison", body)
        self.assertIn("compareExportedReviewPackets", body)
        self.assertIn("/data-deletion-review-packets/compare", body)
        self.assertIn("canonical_field_differences_truncated", body)
        self.assertIn("comparison-table comparison-contract-table", body)
        self.assertIn("comparison-table comparison-check-table", body)
        self.assertIn("comparison-table comparison-canonical-table", body)
        self.assertIn(".comparison-table { min-width: 760px;", body)
        self.assertIn(".review-packet-comparer-form { grid-template-columns: 1fr; }", body)
        self.assertNotIn("/data-deletions/${encodeURIComponent(requestId)}/execute", body)
        self.assertIn("data-backup-evidence-form", body)
        self.assertIn(".backup-evidence-form [hidden] { display: none !important; }", body)
        self.assertIn("backup-readiness-state", body)
        self.assertIn("execution_blockers", body)
        self.assertNotIn("Execute deletion", body)
    ...
    def test_storage_settings_endpoint_updates_paths_and_status(self) -> None:
        with TemporaryDirectory() as temp_dir:
            ...
            quarantine_dir = base_dir / "quarantine-drive" / "quarantine"
            with patch.dict(os.environ, {"PUBG_LOCAL_SETTINGS_FILE": str(settings_file)}):
                client = TestClient(create_app())
                response = client.post(
                    "/settings/storage",
                    json={
                        ...
                        "quarantine_data_dir": str(quarantine_dir),
            ...
            self.assertEqual(
                payload["storage"]["quarantine_data_dir"],
                str(quarantine_dir),
            )
