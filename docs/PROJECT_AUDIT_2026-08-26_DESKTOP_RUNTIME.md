...
4. The desktop release identifier is 2026.08.26.1.
5. dist/PUBG_AI_Manager.exe was rebuilt locally from the same release.
6. A regression test enforces source-before-EXE ordering, the explicit source path, normalized base directory, and
...
- file size: 51,787,355 bytes;
- SHA-256: 91D1D8B3220EBAA37319B79A632A9DD31FD34656A4317E7393B5BD21E4CB0E56;
- native window: PUBG AI Local Manager;
- owned endpoint: 127.0.0.1:8000;
- health release: 2026.08.26.1.

The corrected launcher was then started independently. Its process tree contained the Python module desktop command,
not PUBG_AI_Manager.exe, and its own health endpoint also returned 2026.08.26.1.
...
The final Python suite completed with **647 passed**, 106 dependency deprecation warnings, and no failures.
