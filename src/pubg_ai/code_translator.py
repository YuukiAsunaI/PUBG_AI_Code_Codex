...
ITEM_ID_KO = {
    ...
    "Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Small_C": "대용량 퀵드로우 탄창 (권총)",
    ...
    "Item_Attach_Weapon_Magazine_Extended_Small_C": "대용량 탄창 (권총)",
    ...
    "Item_Attach_Weapon_Magazine_QuickDraw_Small_C": "퀵드로우 탄창 (권총)",
    "Item_Attach_Weapon_Magazine_QuickDraw_SniperRifle_C": "퀵드로우 탄창 (DMR, SR)",
    ...
    "Item_Attach_Weapon_Muzzle_Suppressor_Small_C": "소음기 (권총)",
    "Item_Attach_Weapon_Muzzle_Suppressor_SniperRifle_C": "저격소총 소음기",
    "Item_Attach_Weapon_SideRail_DotSight_RMR_C": "캔티드 사이트",
